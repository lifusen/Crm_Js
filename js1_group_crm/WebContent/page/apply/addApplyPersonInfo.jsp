...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<ul class="breadcrumb">
				...
				<li><a href="javascript:void(0);">录入应聘人员信息</a></li>
	...
	<div class="customerFormContainer">
		...
		<form id="addCustomerBasicInfoForm"
			action="${pageContext.request.contextPath}/applyPerson/addPerson.do"
			method="post">
				...
				<div class="portlet-body">
					<div id="customerBasicInfoArea">
						<table id="" class="formTable">
							<tr>
								<td><label class="control-label">应聘人员姓名</label></td>
								...
								<td><label class="control-label">应聘岗位</label></td>
								<td><input type="text" name="jobs" class="small"
								...
								<td><input type="text" name="year" class="small"
									style="width: 40px;" /></td>
							</tr>
						</table>
						...
						<table style="width: 100%;">
							<tr>
								<td width="50px;"><label class="control-label">应聘情况</label></td>
								<td style="" colspan="14"><textarea name="otherInfo"
										rows="" style="width: 100%;">${applyPerson.otherInfo }</textarea>
								</td>
								<td>&nbsp;</td>
							</tr>
						</table>
