		...
		<div class="span12">
			...
			<ul class="breadcrumb">
				<li><i class="icon-home"></i> <a class="aPost"
					href="${pageContext.request.contextPath}/page/customer/list.jsp">面试人员管理</a>
					<i class="icon-angle-right"></i></li>
				<li><a href="#">面试人员列表</a></li>
			</ul>
		</div>
	</div>
	<div class="row-fluid">
			...
			<div class="portlet box green">
				...
				<div class="portlet-body">
					<div class="customerListArea">
						...
						-->
						<!-- 高级搜索 -->
						<div id="superSearchDiv" class="superSearch hide"
							style="clear: left;">
							<p style="margin: 10px 0 0 10px;">
								部门： <a class="green btn mini all filterBtn"
									href="javascript:void(0);">不限</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">业务一部</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">业务二部</a>
							...
							<p style="margin: 10px 0 0 10px;">
								客户经理： <a class="green btn mini all filterBtn"
									href="javascript:void(0);">不限</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">张三</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">李四</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">王四</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">张三</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">李四</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">王五</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">赵六</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">王四</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">王四</a>
							</p>
							<p style="margin: 10px 0 0 10px;">
								贷款类型： <a class="green btn mini all filterBtn"
									href="javascript:void(0);">不限</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">企贷</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">2贷</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">信贷</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">房贷</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">短借</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">车贷</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">信用卡</a>
							</p>
							<p style="margin: 10px 0 0 10px;">
								客户等级： <a class="green btn mini all filterBtn"
									href="javascript:void(0);">不限</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">优级客户</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">中级客户</a>
								<a class="btn mini filterBtn" href="javascript:void(0);">差级客户</a>
							</p>
							<p style="margin: 10px 0 0 10px;">
								客户状态： <a class="green btn mini all filterBtn"
									href="javascript:void(0);">不限</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">为录资料</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">正常</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">自留</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">签单</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">全局公共池</a>
								<a class="btn mini filterBtn" href="javascript:void(0);">退电</a>
							</p>
							<p style="margin: 10px 0 0 10px;">
								来源首电类型： <a class="green btn mini all filterBtn"
									href="javascript:void(0);">不限</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">直客</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">名单</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">客户介绍</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">中介</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">续贷客户</a>
							...
							<p style="margin: 10px 0 0 10px;">
								时间类型： <a class="green btn mini all filterBtn"
									href="javascript:void(0);">不限</a> <a class="btn mini filterBtn"
									href="javascript:void(0);">反馈时间</a> <a
									class="btn mini filterBtn" href="javascript:void(0);">录入时间</a>
								<a class="btn mini filterBtn" href="javascript:void(0);">签单时间</a>
							</p>
							<p style="margin: 10px 0 0 10px;">
								时间： <input data-provide="datepicker" type="text"
									class="span2 small" readonly="readonly" size="12"> 至 <input
									data-provide="datepicker" type="text" class="span2 small"
						...
						<table
							...
							<thead>
								<tr>
									...
									<th style="min-width: 50px;">面试的岗位</th>
									<th style="min-width: 50px;">年龄</th>
									<th style="min-width: 50px;">工作年限</th>
									<th style="min-width: 25px;">面试情况</th>
									<th style="min-width: 25px;">面试时间</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>张三</td>
									<td>188****1010</td>
									<td><a id="testaaa" href="javascript:;" class="popovers"
										data-trigger="hover" data-html="true"
										data-content="住房:高新区天华一路英俊一期雍雅河鲜旁,面积108,均价9800,精装,9成新,租金3000/月&lt;br/&gt;住房:高新区天华一路英俊一期雍雅河鲜旁,面积108,均价9800,精装,9成新,租金3000/月"
										data-original-title="资产信息"> 房屋1栋,汽车一辆 </a></td>
									<td>小贷</td>
