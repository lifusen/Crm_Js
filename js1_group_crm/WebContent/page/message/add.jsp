		...
		<div class="span12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption"><i class="icon-cogs"></i>发布${typeName}</div>
				</div>
				<div class="portlet-body">		
					<form id="addMessageForm" action="message/add.do" method="post">
						...
						<table style="width:100%; max-width: 1290px;">
							<tr>
								...
								<td>
									...
									<input id="messageTitle" type="text" name="title" style="width:98.6%;"/>
								</td>
							</tr>
							<tr>
								<td>
...
$(function(){
	 $("#addMessageForm").validate({
		...
		messages: {
			...
			$.post($("#addMessageForm").attr("action"),{type:messageType,title:messageTitle,content:messageContent},function(data){
				if(data){
					//alert('添加成功!');
