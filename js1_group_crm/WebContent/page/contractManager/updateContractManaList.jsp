...
<div class="container-fluid">
	...
	<div class="customerFormContainer">
		...
		<form id="addCustomerBasicInfoForm"
			action="${pageContext.request.contextPath}/contractManager/update.do"
			method="post">
			<input type="hidden" name="id" value="${contractManager.id}" />
				...
				<div class="portlet-body">
					<div id="customerBasicInfoArea">
						<table id="" class="formTable">
							<tr cId="${contractManager.id}">
								<td width="50px"><label class="control-label">联系人</label></td>
								<td width="160px"><input id="custAuthorizedPer" type="text"
									name="custAuthorizedPer" class="small" style="width: 100px;"
									value="${contractManager.custAuthorizedPer }"></td>
								<td><label class="control-label">联系方式<span
										class="required">*</span></label></td>
								<td><input id="customerPhone" type="text" name="phone"
									class="small" style="width: 100px;"
									value="${contractManager.phone}"> <a
								...
								<td width="140px"><input id="itemName" type="text"
									name="itemName" class="small" style="width: 100px;"
									value="${contractManager.itemName}"></td>
								<td width="50px"><label class="control-label">项目编号</label></td>
								<td width="140px"><input id="itemNo" type="text"
									name="itemNo" class="small" style="width: 100px;"
									value="${contractManager.itemNo}"></td>
								<td style="display: none"><label class="control-label">年龄</label></td>
								<td style="display: none"><input type="text" name="age"
									class="small" maxlength="2" style="width: 40px;"
									value="${contractManager.age}" /></td>
							...
							<tr>
								...
								<td>
									<div class="input-append date form_datetime">
										<input data-provide="datepicker" type="text" class=""
											readonly="readonly" value="${contractManager.startDate}"
											size="12" style="width: 100px;" name="startDate">
									</div>
								</td>
								...
								<td>
									<div class="input-append date form_datetime">
										<input data-provide="datepicker" type="text" class=""
											readonly="readonly" value="${contractManager.endDate}"
											size="12" style="width: 100px;" name="endDate">
									</div>
								</td>
								<td><label class="control-label">维护周期</label></td>
								<td><input id="cycle" type="text" name="cycle"
									class="small" style="width: 100px;"
									value="${contractManager.cycle}"></td>
								<td><label class="control-label">录入人员编号（勿改）</label></td>
								<td><input id="addPersonId" type="text" name="addPersonId"
									class="small" style="width: 100px;"
									value="${contractManager.addPersonId}"></td>
							</tr>
							<tr>
								<td width="90px"><span
							...
							<tr>
								...
								<td><input id="envirVarible" type="text"
									...
									style="width: 100px;" value="${contractManager.envirVarible}"></td>
								<td><label class="control-label">其他</label></td>
								<td><input id="other" type="text" name="other"
									class="small" style="width: 100px;"
									value="${contractManager.other}"></td>
							</tr>
							<tr>
								<td width="60px"><span
							...
							<tr>
								...
								<td>
									<div class="input-append date form_datetime">
										<input data-provide="datepicker" type="text" class=""
											readonly="readonly" value="${contractManager.startDatePlan}"
											size="12" style="width: 100px;" name="startDatePlan">
									</div>
								</td>
							...
							<tr>
								...
								<td><input id="accepData" type="text" name="accepData"
									class="small" style="width: 100px;"
									value="${contractManager.accepData}"></td>
								<td><label class="control-label">是否交付</label></td>
								<td><select id="workYearSelect" name="accDelivery"
									class="small m-wrap">
										<c:choose>
											<c:when test="${contractManager.accDelivery=='已交付'}">
												<option value="已交付" selected>已交付</option>
												<option value="未交付">未交付</option>
											</c:when>
											<c:otherwise>
												<option value="已交付">已交付</option>
												<option value="未交付" selected>未交付</option>
											</c:otherwise>
										</c:choose>
								</select>
								...
								<td><input id="sourceCode" type="text" name="sourceCode"
									class="small" style="width: 100px;"
									value="${contractManager.sourceCode}"></td>
								<td><label class="control-label">是否交付</label></td>
								<td><select id="workYearSelect" name="souDelivery"
									class="small m-wrap">
										<c:choose>
											<c:when test="${contractManager.souDelivery=='已交付'}">
												<option value="已交付" selected>已交付</option>
												<option value="未交付">未交付</option>
											</c:when>
											<c:otherwise>
							...
							<tr>
								...
								<td><input id="serverProvider" type="text"
									name="serverProvider" class="small" style="width: 100px;"
									value="${contractManager.serverProvider}"></td>
								<td><label class="control-label">服务器供应商</label></td>
								<td><input id="serverVendor" type="text"
									name="serverVendor" class="small" style="width: 100px;"
									value="${contractManager.serverVendor}"></td>
							</tr>
							<tr>
								<td><label class="control-label">服务器地址</label></td>
								<td style="" colspan="14"><textarea name="serverAddr"
										rows="" style="width: 70%;">${contractManager.serverAddr }</textarea></td>

							</tr>
							<tr>
								<td><label class="control-label">服务器账号</label></td>
								<td><input id="serverAccount" type="text"
									name="serverAccount" class="small" style="width: 100px;"
									value="${contractManager.serverAccount}"></td>
								<td><label class="control-label">服务器密码</label></td>
								<td><input id="serverPassword" type="text"
									name="serverPassword" class="small" style="width: 100px;"
									value="${contractManager.serverPassword}"></td>
								<td><label class="control-label">上线域名</label></td>
								<td><input id="domainName" type="text" name="domainName"
									class="small" style="width: 100px;"
									value="${contractManager.domainName}"></td>
							</tr>
							<tr>
								<td><label class="control-label">后台管理地址</label></td>
								<td><input id="managementAddr" type="text"
									name="managementAddr" class="small" style="width: 100px;"
									value="${contractManager.managementAddr}"></td>
								<td><label class="control-label">后台管理账号</label></td>
								<td><input id="managementAccount" type="text"
									name="managementAccount" class="small" style="width: 100px;"
									value="${contractManager.managementAccount}"></td>
								<td><label class="control-label">后台管理密码</label></td>
								<td><input id="managementPassword" type="text"
									name="managementPassword" class="small" style="width: 100px;"
									value="${contractManager.managementPassword}"></td>
							</tr>
							<tr>
								<td width="60px"><span
							...
							<tr>
								...
								<td style="" colspan="14"><textarea name="RemServerAddr"
										rows="" style="width: 70%;">${contractManager.remServerAddr}</textarea></td>
							</tr>
							<tr>
								<td><label class="control-label">本地服务器部署地址</label></td>
								<td style="" colspan="14"><textarea name="localServerAddr"
										rows="" style="width: 70%;">${contractManager.localServerAddr}</textarea></td>
							</tr>
							<tr>
								<td><label class="control-label">本地服务器备份位置</label></td>
								<td style="" colspan="14"><textarea
										name="localServerBackUp" rows="" style="width: 70%;">${contractManager.localServerBackUp}</textarea></td>
							</tr>
							<tr>
								<td><label class="control-label">移动硬盘备份位置</label></td>
								<td style="" colspan="14"><textarea name="hardDiskBackUp"
										rows="" style="width: 70%;">${contractManager.hardDiskBackUp}</textarea></td>
							...
							<tr>
								...
								<td><input id="contractNO" type="text" name="contractNO"
									class="small" style="width: 100px;"
									value="${contractManager.contractNO}"></td>
								<td><label class="control-label">合同总金额</label></td>
								<td><input id="contractPrice" type="text"
									name="contractPrice" class="small" style="width: 100px;"
									value="${contractManager.contractPrice}"></td>
								<td><label class="control-label">拍照扫描</label></td>
								<td><select id="workYearSelect" name="photoScan"
									class="small m-wrap">
										<c:choose>
											<c:when test="${contractManager.photoScan=='已扫描'}">
												<option value="已扫描" selected>已扫描</option>
												<option value="未扫描">未扫描</option>
											</c:when>
											<c:otherwise>
												<option value="已扫描">已扫描</option>
												<option value="未扫描" selected>未扫描</option>
											</c:otherwise>
										</c:choose>
								</select>
							</tr>
							<tr>
								...
								<td>
									<div class="input-append date form_datetime">
										<input data-provide="datepicker" type="text" class=""
											readonly="readonly" value="${contractManager.signDate}"
											size="12" style="width: 100px;" name="signDate">
									</div>
								</td>
								...
								<td>
									<div class="input-append date form_datetime">
										<input data-provide="datepicker" type="text" class=""
											readonly="readonly" value="${contractManager.completDate}"
											size="12" style="width: 100px;" name="completDate">
									</div>
								</td>

								<td><label class="control-label">支付方式</label></td>
								<td><input id="paymentTerms" type="text"
									name="paymentTerms" class="small" style="width: 100px;"
									value="${contractManager.paymentTerms}"></td>
							</tr>
							<tr>
								<td><label class="control-label">支付金额</label></td>
								<td><input id="price" type="text" name="price"
									class="small" style="width: 100px;"
									value="${contractManager.price}"></td>
								...
								<td><input id="havetopay" type="text" name="havetopay"
									class="small" style="width: 100px;"
									value="${contractManager.havetopay}"></td>
								<td><label class="control-label">支付日期</label></td>
								<td>
									<div class="input-append date form_datetime">
										<input data-provide="datepicker" type="text" class=""
											readonly="readonly" value="${contractManager.payDate}"
											size="12" style="width: 100px;" name="payDate">
									</div>
								</td>
							</tr>
							<tr>
