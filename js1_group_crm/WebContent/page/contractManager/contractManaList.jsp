		...
		<form class="updateSignCustomerForm" action="">
			<table class="formTable signCustomerTable">
				...
				<tr>
					...
					<td><input id="customerFollowRemindTime" name="remindTime"
				...
				<tr>
					...
					<td width="140px"><input id="customerFollowRemindTime"
						name="remindTime" size="12" style="width: 120px;" type="text"
						value="" readonly></td>
				...
				<tr>
					<td><label class="control-label">外部合作情况（合作内容）</label></td>
					<td><input type="text" name="costOfContract" class="input"
						value="<fmt:formatNumber pattern="#.#" maxFractionDigits="2" value="${sc.costOfContract}"/>"
						maxlength="11" /></td>
