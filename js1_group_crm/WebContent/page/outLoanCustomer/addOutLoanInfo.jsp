...
<!-- 放款客户模板 start-->
<div id="outLoanCustomerTemplateContainer" style="display: none;">
	<div class="outLoanCustomerTemplate add" style="padding-bottom:10px;">
			...
			<table class="formTable">
				<tr>
					...
					<td width="150px">
						...
						<input type="hidden" name="warranterId" value="${loginUser.id }"/>
				...
				<tr>
					<td width="50px"><label class="control-label">上 门 费</label></td>
					<td width="150px">
						<input type="text" name="visitCharge" class="input width120" > 
					</td>
					<td width="50px"><label class="control-label">渠道成本</label></td>
					<td width="150px">
						<input type="text" name="channelCost" class="input width120" > 
					</td>
					<td width="50px"><label class="control-label">其 他 费</label></td>
					<td width="150px">
						<input type="text" name="otherCost" class="input width120" > 
					</td>
					<td width="50px"><label class="control-label">返&nbsp;点</label></td>
					<td width="150px">
						<input type="text" name="rebate" class="input width120" > 
					</td>
				</tr>
				<tr style="border-top:1px dashed green;">
					<td width="50px"><label class="control-label">用&nbsp;途</label></td>
					<td width="150px">
						<input type="text" name="purpose" class="input width120" > 
					</td>
					<td width="50px"><label class="control-label">征 信 费</label></td>
					<td width="150px">
						<input type="text" name="creditCost" class="input width120" > 
					</td>
					<td width="50px"><label class="control-label">电&nbsp;票</label></td>
					<td width="150px">
						<input type="text" name="electricCost" class="input width120" > 
					</td>
				</tr>
				<tr>
					<td width="50px"><label class="control-label">工作证明</label></td>
					<td width="150px">
						<input type="text" name="workProve" class="input width120" > 
					</td>
					<td width="50px"><label class="control-label">快 递 费</label></td>
					<td width="150px">
						<input type="text" name="postage" class="input width120" >
					</td>
					<td width="50px"><label class="control-label">面 签 费</label></td>
					<td width="150px">
						<input type="text" name="checkCost" class="input width120" >
					</td>
				</tr>
				<tr>
					<td width="50px"><label class="control-label">座 机 费</label></td>
					<td width="150px">
						<input type="text" name="telephoneCost" class="input width120" >
					</td>
					<td width="50px"><label class="control-label">电 话 卡</label></td>
					<td width="150px">
						<input type="text" name="phoneCard" class="input width120" >
					</td>
					<td width="50px"><label class="control-label">纯 处 理</label></td>
					<td width="150px">
						<input type="text" name="onlyHandle" class="input width120" >
					</td>
				</tr>
				<tr style="border-top:1px dashed green;">
					<td width="50px"><label class="control-label">房&nbsp;龄</label></td>
					<td width="150px">
						<input type="text" name="houseAge" class="input width120" > 
					</td>
				...
				<tr>
					...
					<td width="50px"><label class="control-label">保 险 费</label></td>
					<td width="150px">
						<input type="text" name="insuranceCost" class="input width120"/> 
					</td>
				</tr>
		...
		<div class="form-actions" style="padding:8px;text-align:center;margin-top:5px;margin-bottom:10px;" >
			<button id="addOutLoanCustomerBtn" class="btn blue" type="button" onclick="addOutLoanCustomer(this)"><i class="icon-ok"></i> 保存</button>
 ...
 * 添加放款客户模板
 */
 function outLoanCustomerTemplate(){
	/* var template = $('#outLoanCustomerTemplateContainer>.outLoanCustomerTemplate').clone().prependTo($('#outLoanCustomerArea'));
	var select = $(template).find('td.lendingInstitutionTd>select');
	activeSelectChosenObject($(select)); */
	var template = $('#outLoanCustomerTemplateContainer').show();
}
...
function addOutLoanCustomer(obj){
	...
	$.post('outLoanCustomer/addOutLoanCustomer.do',v,function(data){
		if(data==true){
			...
			$(obj).attr('disabled',true).removeClass('blue');
		}else{
			alert('添加放款客户失败!');
		}
	});
