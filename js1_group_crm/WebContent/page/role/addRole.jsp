		...
		<div class="span12">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption"><i class="icon-cogs"></i>添加角色</div>
					<div class="tools">
				...
				<div class="portlet-body">
					...
					<form id="addRoleForm" action="role/addRole.do" method="post">
						<table class="formTable" style="margin-left: 300px;">
							<tr>
								<td><label class="control-label">　名　称<span class="required">*</span></label></td>
								<td>
									<input type="text" id="roleName" name="roleName" class="m-wrap medium" style="width:100px;">
								</td>
							</tr>
							<tr>
						...
						<c:forEach items="${requestScope.menuTrees }" var="menuTree">
							<div style="width:250px;padding-left: 30px;float: left;">
								<label class="control-label" style="font-weight: bold;"><input type="checkbox" name="menus" class="menuParent-${menuTree.menu.id }" onchange="allChecked(this);" value="${menuTree.menu.id }">${menuTree.menu.name }</label>
										...
										<div class="span3">
											<c:forEach items="${menuTree.menus }" var="menu">
												<label class="checkbox line" style="width:170px;">
													<span><input type="checkbox" class="menus-${menuTree.menu.id }" onchange="checkedParent(this);" name="menus" value="${menu.id }"></span> ${menu.name }
												</label>
											</c:forEach>
										</div>
									</div>
	...
	$(function(){
		 $("#addRoleForm").validate({
			...
			messages: {
				...
				$.post($("#addRoleForm").attr("action"),{roleName:roleName,remark:remark,menus:menusVal},function(data){
					if(data){
