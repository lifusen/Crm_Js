	...
	<div class="row-fluid">
		<div class="span12">
			...
			<ul class="breadcrumb">
				...
				<li><a href="javascript:void(0);">已分配订单</a></li>
			</ul>
		</div>
	</div>
	<div class="row-fluid">
		...
		<div class="span12">
			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption"><i class="icon-globe"></i>已分配订单</div>
					<div class="tools">
				...
				<div class="portlet-body">
					...
					<div id="tableList">
						<jsp:include page="allotOrder-List.jsp" />
					</div>
				</div>
			</div>
		</div>
	...
	$(function(){
		...
		$("#keyStr").keyup(function(event){
			 if(event.keyCode == 13){
				...
				$("#tableList").load("customer/getAssignedOrderList.do?initPage=1&pageIndex=1&keyStr="+val);
			 }
		 });
