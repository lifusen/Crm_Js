...
@Repository("applyPersonListDao")
public class ApplyPersonListDaoImpl extends BaseDaoSupport<ApplyPerson> implements ApplyPersonListDao {
	...
	public List<Map<String, Object>> getCustomersByStateAndEId(Integer pageIndex, Integer pageSize, Integer[] eIds,
		...
		String sqlName = "getValidPersonList";
		return getApplyPersonByStateAndEId(pageIndex, pageSize, eIds, keyStr, null, null, sqlName, null, null, fLevel,
				cLevel);
	}
	...
	public List<Map<String, Object>> getApplyPersonByStateAndEId(Integer pageIndex, Integer pageSize, Integer[] eIds,
		...
		if (sqlName.equals("getValidPersonList") || sqlName.equals("getCustomerReminderListByEmployeeIds")
