...
public class RejectCustomerController extends BaseController{
	...
	@RequestMapping("getRejectCustomerList")
	public String getRejectCustomerList(Integer pageIndex,Integer pageSize,
		...
		System.out.println("rejectCustomers==============>");
		...
		builderParam(model, pageIndex, pageSize, count, 
				"rejectCustomer/getRejectCustomerList.do?initPage=1&keyword="+keyword
		...
		if (initPage==null) {
			return "page/rejectCustomer/listUI";
		}
		return "page/rejectCustomer/list";
	}
